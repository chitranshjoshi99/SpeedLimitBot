#!/bin/bash
# Drives a synthetic track past the real camera at 13.198438,77.698776 (limit 80 km/h),
# north of Bengaluru and 7.8 km clear of any other camera in the dataset.
